...
def draw_h3(rc, base_page: int) -> None:
    ...
    y = L.form_title(
        rc,
        "Employee File and Work Authorization",
    ...
    rc.text(
        L.LEFT,
        y,
        "The employee presented the documents below in person; the issuing state and "
        "the expiry were sighted and returned.",
        L.REG,
        8,
        L.GRAY,
    )
    ...
    rc.text(
        L.LEFT,
        y,
        "The employee certifies that the identity documents presented are genuine and "
        "relate to the employee named above.",
        L.REG,
        8.5,
        L.GRAY,
    )
...
def draw_h4(rc, base_page: int) -> None:
    ...
    rc.text(
        px + 12, y, "semi-monthly cycle; gross wages before every deduction.", L.REG, 8.5, L.GRAY
    )
    y -= 15
    cols = [
        (L.LEFT, "Earnings"),
        (L.LEFT + 160, "Current"),
        (L.LEFT + 250, "Year to date"),
        (L.LEFT + 370, "Withholding"),
        (L.LEFT + 470, "Current"),
    ]
    ...
    rc.text(
        px + 8,
        y,
        "-- nine digits, direct deposit line, verified at enrollment.",
        L.REG,
        8.5,
        L.GRAY,
    )
    ...
    lx = rc.text(
        L.LEFT + 250, y, G["occ_h4_05"].label_context, L.MED, 8.5, L.GRAY
    )  # Account on file:
    ...
    lx = rc.text(
        L.LEFT + 220, y, G["occ_h4_07"].label_context, L.MED, 8.5, L.GRAY
    )  # Date of Birth:
    ...
    lx = rc.text(
        L.LEFT + 220, y, G["occ_h4_09"].label_context, L.MED, 8.5, L.GRAY
    )  # Date of Birth:
    ...
    rc.text(
        px + 10,
        y,
        "high deductible with a savings election; employee plus family tier.",
        L.REG,
        8.5,
        L.GRAY,
    )
    y -= 14
    lx = rc.text(
        L.LEFT, y, G["occ_h4_13"].label_context, L.MED, 8.5, L.GRAY
    ...
    rc.text(
        L.LEFT,
        y,
        "The employee authorizes the deduction shown and certifies that every "
        "dependent listed is eligible under the plan.",
        L.REG,
        8.5,
        L.GRAY,
    )
    ...
    rc.text(
        L.LEFT + 250,
        y,
        "Filed with the payroll office; retained for the plan year.",
        L.REG,
        8,
        L.FAINT,
    )
    ...
    rc.text(
        L.LEFT,
        y,
        "Synthetic enrollment prepared for software testing; every person, identifier, "
        "wage, and date shown is fictional and disclosed.",
        L.REG,
        7.5,
        L.FAINT,
    )
