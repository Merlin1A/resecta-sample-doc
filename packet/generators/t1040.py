...
def draw(rc, base_page: int) -> None:
    ...
    y = L.form_title(
        rc,
        "U.S. Individual Income Tax Return (specimen)",
    ...
    L.labeled(rc, L.LEFT, y, "Employer Name:", P.EMPLOYER_NAME)
    y -= 14
    ...
    y = C.continuation_header(
        rc, "U.S. Individual Income Tax Return (specimen) -- continued", "Page 8 of 12"
    )
    ...
    y -= 12
    lx = rc.text(
        L.LEFT, y, G["occ_t1040_14"].label_context, L.REG, 8.5, L.GRAY
