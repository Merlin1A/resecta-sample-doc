...
def draw(rc, base_page: int) -> None:
    ...
    y = L.form_title(rc, "Wage and Tax Statement (specimen)",
    ...
    rc.text(L.LEFT + 6, y - 16, "Tannersworth Freight Systems, Inc.", L.REG, 9, L.INK)
    ...
    lx = rc.text(colR, y - 12, G["N-EIN-1"].label_context, L.MED, 8, L.GRAY)   # 15 Employer's state ID no.:
    ...
    lx = rc.text(L.LEFT + 150, y, G["occ_w2_06"].label_context, L.REG, 8.5, L.GRAY)   # for example, 07-3300449.
