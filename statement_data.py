...
ACCOUNT_HOLDER_ACH = (
    "DELIA HARTWELL"  # INDN: form in ACH descriptors (uppercase, no middle initial)
)
...
ACCOUNT_NUMBER = "4100773265"  # full 10-digit fictional (no checksum standard applies)
...
TRANSACTIONS: list[Txn] = [
    ...
    Txn(
        ...
        "credit",
        D("2113.44"),
        _ach("NORTHLINE LOGISTICS DIRECT DEP DES:PAYROLL ID:PR4471", "9100004821", "PPD"),
    ),
    Txn(
        15,
        "credit",
        D("2113.44"),
        _ach("NORTHLINE LOGISTICS DIRECT DEP DES:PAYROLL ID:PR4472", "9100004821", "PPD"),
    ),
    ...
    Txn(
        ...
        "withdrawal",
        D("1450.00"),
        _ach("ASHWOOD RESIDENTIAL DES:RENT ID:RNT0521", "8120049173", "PPD"),
    ),
    ...
    Txn(
        ...
        "withdrawal",
        D("128.64"),
        _ach("VALLEY POWER & LIGHT DES:UTILITY ID:VPL55021", "7330081265", "WEB"),
    ),
    ...
    Txn(
        ...
        "withdrawal",
        D("79.99"),
        _ach("NORTHSTAR BROADBAND DES:INTERNET ID:NSB73310", "6650094412", "WEB"),
    ),
    ...
    Txn(
        ...
        "withdrawal",
        D("15.99"),
        _ach("STREAMHARBOR MEDIA DES:SUBSCRIPT ID:SHM10293", "5540063370", "WEB"),
    ),
    ...
    Txn(
        ...
        "withdrawal",
        D("60.00"),
        ("ATM WITHDRAWAL 0521 #BO0938 MERIDIAN CROSSROADS MERIDIAN ID",),
    ),
...
def credits() -> list[Txn]:  # noqa: A001 -- the module's data API names the ledger sections
